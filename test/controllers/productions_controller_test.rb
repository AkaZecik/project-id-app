...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { author: @production.author, name: @production.name, production_id: @production.production_id, production_type_id: @production.production_type_id } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { author: @production.author, name: @production.name, production_id: @production.production_id, production_type_id: @production.production_type_id } }
