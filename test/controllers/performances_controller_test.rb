...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { performance_id: @performance.performance_id, song_id: @performance.song_id } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { performance_id: @performance.performance_id, song_id: @performance.song_id } }
